...
function customerProfile(req) {
  ...
  const capabilitySets = {
    ...
    developer: ['fleet.read', 'sku.read', 'sku.manage', 'sku.policy.manage', 'firmware.release.read', 'firmware.release.manage', 'ota.plan.read', 'ota.plan.manage', 'reports.read', 'reports.create', 'team.read', 'team.manage', 'pki.test.issue', 'provisioning.read', 'provisioning.create', 'billing_account.read', 'billing_ledger.read', 'billing_summary.read', 'billing_usage.read', 'invoice.read', 'invoice_document.read', 'billing_activity.read', 'billing_profile.read', 'billing_profile.manage', 'billing_statement.export', 'payment_method.read', 'payment_method.manage', 'payment_intent.read', 'payment_intent.create', 'auto_topup.read', 'auto_topup.manage'],
