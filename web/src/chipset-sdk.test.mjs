...
const chipsets = [{ name: 'AmebaPro2', vendor: 'Realtek', family: 'Ameba', resources: [{ type: 'forum', title: 'Ameba Forum', languages: ['en'] }], sdk_releases: [{ name: 'Arduino', version: '4.0.8', recommended: true, supported_models: ['AMB82-Mini'], endpoints: [{ type: 'github', title: 'Source' }, {}] }] }];
...
test('developer catalog helpers filter releases and summarize cards', () => {
  ...
  assert.equal(providerEndpointCount(chipsets), 3);
