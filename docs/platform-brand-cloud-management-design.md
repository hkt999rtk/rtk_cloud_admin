...
<!-- rtk-requirement
{"acceptance_layer":"ui","operation_model":"workflow","gate":"pr","environments":["ci"],"evidence":["json","screenshots"],"required":true,"status":"active"}
-->
...
<!-- rtk-requirement
{"acceptance_layer":"unit","gate":"pr","environments":["ci"],"evidence":["json"],"required":false,"status":"planned"}
-->
