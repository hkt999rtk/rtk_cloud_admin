...
var pkiPath = regexp.MustCompile(`^/(issuers|operations)(/search|/[0-9a-f-]{36}(/(operations|approvals|cancel|provision|import|activate|execute|reconcile|crl|revocation-complete))?)?$`)
