...
func FromEnv() Config {
	return Config{
		...
		SDKPortalBaseURL:                    os.Getenv("SDK_PORTAL_BASE_URL"),
		...
		FactoryEnrollPublicBaseURL:          os.Getenv("FACTORY_ENROLL_PUBLIC_BASE_URL"),
